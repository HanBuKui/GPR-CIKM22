...
DATA_DIR = {
    LAST_FM: '../SCPR-data/data/lastfm',
    YELP: '../SCPR-data/data/yelp',
    LAST_FM_STAR: '../SCPR-data/data/lastfm_star',
    YELP_STAR: '../SCPR-data/data/yelp',
}
...
TMP_DIR = {
    ...
    LAST_FM: '../SCPR-data/tmp/last_fm',
    YELP: '../SCPR-data/tmp/yelp',
    LAST_FM_STAR: '../SCPR-data/tmp/last_fm_star',
    YELP_STAR: '../SCPR-data/tmp/yelp_star',
}
def cuda_(var):
